...
export const TEACHER_ROUTES = {
  ...
  QUIZZES_CREATE: "/dashboard/teacher/quizzes/create",
  QUIZZES_PREVIEW: "/dashboard/teacher/quizzes/:quizId/preview",
  QUIZZES_EDIT: "/dashboard/teacher/quizzes/:quizId/edit",
  QUIZZES_REPUBLISH: "/dashboard/teacher/quizzes/:quizId/republish",
