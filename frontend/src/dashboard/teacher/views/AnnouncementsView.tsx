    ...
    <div className="w-full overflow-x-hidden p-4 sm:p-6">
      <div className="flex w-full gap-6 overflow-x-hidden">
        ...
        <section className="min-w-0 flex-1 space-y-4">
          <AnnouncementHeader title="Announcements" subtitle={selectedSubjectName ? `Subject: ${selectedSubjectName}` : "Choose a subject from the sidebar to manage announcements"} subjectName={selectedSubjectName} />
