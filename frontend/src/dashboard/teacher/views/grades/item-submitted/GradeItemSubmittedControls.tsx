// Renders the submitted-list tab switcher and search input.
...
export function GradeItemSubmittedControls({ state }: Props) {
  return (
    <>
      <div className="teacher-panel-surface rounded-2xl p-4">
        <SegmentedTabs
          value="submitted"
          options={[
