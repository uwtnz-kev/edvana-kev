  ...
  return (
    <div className="border-t border-white/10 p-6">
      <div className="rounded-2xl border border-white/15 bg-white/10 p-4 backdrop-blur-md">
        <Textarea value={state.reply} onChange={(event) => state.setReply(event.target.value)} placeholder="Write a reply..." className="min-h-[70px] max-h-[120px] resize-none border-0 bg-transparent px-0 text-[#3B240F] placeholder:text-[#6B4F3A]/70 focus-visible:ring-0" />
