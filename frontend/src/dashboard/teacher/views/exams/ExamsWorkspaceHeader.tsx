...
export function ExamsWorkspaceHeader({ workspace }: Props) {
  return (
      ...
      {!workspace.selectedSubject ? (
        <>
          ...
          <section className="flex-1 min-w-0 space-y-4">
            <TeacherExamsHeader title="Exams" subtitle="Choose a subject from the sidebar to manage exams" subjectName={null} showBack={false} showCreate={false} onBack={workspace.onBack} canCreate={false} onCreate={workspace.onCreate} />
            <TeacherExamsHome />
          </section>
        </>
      ) : null}
