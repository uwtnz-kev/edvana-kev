  ...
  return (
    <div className="w-full p-4 sm:p-6">
      <div className="max-w-3xl mx-auto teacher-panel-surface rounded-2xl p-6 sm:p-8 text-center">
        <h1 className="text-[var(--text-primary)] text-2xl font-semibold">Attendance record not found</h1>
        <p className="text-[var(--text-secondary)] mt-3">The attendance record may have been deleted or the link is invalid.</p>
        <div className="mt-5">
