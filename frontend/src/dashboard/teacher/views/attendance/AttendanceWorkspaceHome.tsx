...
export function AttendanceWorkspaceHome({ workspace, onBackToClassEntry }: Props) {
  return (
    <div className="flex w-full gap-6">
      ...
      <section className="flex-1 min-w-0 space-y-4">
        <AttendanceHeader title="Attendance" subtitle="Choose a subject from the sidebar to manage attendance" subjectId={null} showBack showCreate={false} onBack={onBackToClassEntry} canCreate={false} onCreate={workspace.onCreate} />
