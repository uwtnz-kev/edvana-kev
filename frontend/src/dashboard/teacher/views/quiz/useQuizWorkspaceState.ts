...
export function useQuizWorkspaceState() {
  ...
  const [search, setSearch] = useState(""); const [statusFilter, setStatusFilter] = useState<QuizStatusFilter>("all"); const [page, setPage] = useState(1); const [previewId, setPreviewId] = useState<string | null>(null);
  ...
  return {
    canCreate, page, pagedQuizzes, previewQuiz, search, selectedSubject, selectedSubjectId, stats, statusFilter, subjects, totalPages,
