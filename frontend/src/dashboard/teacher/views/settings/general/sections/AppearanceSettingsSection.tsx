  ...
  return (
    <div className="space-y-4 border-t border-white/10 pt-6">
      ...
      <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/10">
        <div className="flex items-center space-x-3"><div className="flex h-12 w-12 items-center justify-center rounded-xl bg-amber-500/15 p-3 text-amber-300"><Moon className="h-6 w-6" /></div><div><div className="flex items-center space-x-2"><Label htmlFor="dark-mode" className="text-white font-medium">Dark Mode</Label><span className="px-2 py-1 bg-[#1EA896]/20 text-[#1EA896] text-xs font-medium rounded-full">Coming Soon</span></div><p className="text-white/60 text-sm">Switch between light and dark themes for comfortable viewing</p></div></div>
