    ...
    return (
      <div className="w-full p-4 sm:p-6">
        <div className="max-w-3xl mx-auto bg-white/10 border border-white/10 backdrop-blur-xl rounded-2xl p-6 sm:p-8 text-center">
          ...
          <h1 className="text-[#3B240F] text-2xl font-semibold mt-4">Exam not found</h1>
          <p className="text-[#3B240F]/70 mt-3">The exam may have been deleted or the link is invalid.</p>
          <div className="mt-5">
            <Button
              type="button"
