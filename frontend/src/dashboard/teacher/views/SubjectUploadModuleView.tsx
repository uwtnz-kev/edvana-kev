  ...
  return (
    <div className="w-full overflow-x-hidden p-4 sm:p-6" style={{ overflowX: "hidden" }}>
      <div className="mx-auto w-full max-w-6xl space-y-4">
        <UploadModuleHeader title="Create Module" subjectName={subjectName} theme={theme} onBack={() => navigate(appendClassIdToPath(`/dashboard/teacher/subjects/${subjectId}`, classId), { state: { restoreSubjectId: subjectId } })} />
