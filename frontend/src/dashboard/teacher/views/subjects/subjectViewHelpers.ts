...
import { BookOpen, FileText, Plus, Upload, type LucideIcon } from "lucide-react";
...
export function getSubjectSidebarActions(subjectId: string, classId?: string | null) {
  return [
    ...
    { value: "create-module", label: "Create Module", icon: Plus, to: appendClassIdToPath(`/dashboard/teacher/subjects/${subjectId}/create-module`, classId) },
