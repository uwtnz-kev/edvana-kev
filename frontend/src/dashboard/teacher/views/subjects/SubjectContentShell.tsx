    ...
    <section className="rounded-2xl border border-white/20 bg-white/10 p-6 backdrop-blur-lg">
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <h2 className="mt-2 text-lg font-semibold text-[#4B2E1F]">{selectedSubjectData.title}</h2>
          <p className="mt-1 text-sm text-[#4B2E1F]/70">Choose Modules or Upload Module from the left to open the dedicated subject page.</p>
        </div>
      </div>
    </section>
  );
