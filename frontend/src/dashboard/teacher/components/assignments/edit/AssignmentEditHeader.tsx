    ...
    <header className="bg-white/10 border border-white/10 backdrop-blur-xl rounded-2xl p-4 sm:p-5">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          <Button type="button" onClick={onBack} className="bg-white/15 hover:bg-white/20 text-[#3B240F] border border-white/20 rounded-2xl">
          ...
          <div>
            <h1 className="text-[#3B240F] text-2xl sm:text-3xl font-bold">Edit Assignment</h1>
