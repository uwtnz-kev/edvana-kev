    ...
    <header className="teacher-panel-surface rounded-2xl p-4 sm:p-5">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white sm:text-3xl">Edit Quiz</h1>
            <p className="mt-1 text-sm text-[var(--text-secondary)]">Update quiz details and save changes.</p>
          </div>
        </div>
      </div>
