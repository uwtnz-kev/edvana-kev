 ...
 * ---------------------
 * Renders the empty state for the teacher dashboard q ui z feature.
 */
...
export function TeacherQuizEmptyState({
  message,
  onCreate,
  ...
  return (
    <div className="teacher-panel-surface rounded-2xl p-8 text-center teacher-panel-hover">
      ...
      <h3 className="text-white text-xl font-semibold mt-4">No quizzes yet</h3>
