...
export function AssessmentCardHeader({ iconClass, iconContainerClass, title }: Props) {
  return (
    <div className="flex items-start gap-3">
      <div className={`h-14 w-14 rounded-xl p-3 flex items-center justify-center shrink-0 transition-transform duration-200 group-hover:scale-105 ${iconContainerClass}`}>
