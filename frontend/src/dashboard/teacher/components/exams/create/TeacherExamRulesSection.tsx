    ...
    return (
      <div className="grid grid-cols-1 gap-4">
        <div className="space-y-2">
          ...
          <Textarea id="exam-rubric" value={values.rubric} onChange={(event) => onFieldChange("rubric", event.target.value)} onBlur={() => onFieldBlur("rubric")} placeholder="Scoring criteria and weight distribution" className="min-h-[110px] border-white/20 bg-white/20 text-white placeholder:text-white/70" />
        </div>
    ...
    <div className="grid grid-cols-1 gap-4">
      ...
      <div className="space-y-2">
        <div className="mb-2 flex items-center justify-between">
          <label htmlFor="exam-questions-text" className="text-sm text-white">Questions</label>
        ...
        <Textarea id="exam-questions-text" value={values.questionsText} readOnly onBlur={() => onFieldBlur("questionsText")} placeholder="Use Input Questions to add questions" className="min-h-[140px] cursor-not-allowed border-white/15 bg-white/10 text-white placeholder:text-white/70" />
