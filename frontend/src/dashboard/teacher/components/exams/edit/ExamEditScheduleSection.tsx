  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="w-full">
        <label htmlFor="exam-edit-submission-methods" className="mb-2 block text-sm text-white">Submission Method</label>
        <div id="exam-edit-submission-methods" className="rounded-2xl border border-white/20 bg-white/10 px-4 py-3 text-sm text-white">
