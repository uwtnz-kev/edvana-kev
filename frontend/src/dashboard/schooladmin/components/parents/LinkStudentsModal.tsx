...
export default function LinkStudentsModal({
  ...
  const hasChanges =
    JSON.stringify([...selectedStudentIds].sort()) !== JSON.stringify([...parent.studentIds].sort());
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-between pt-6 border-t border-white/20">
                ...
                <div className="flex gap-3">
                  <Button type="button" variant="destructiveOutline" onClick={handleClose} className="rounded-xl">
                    Cancel
                  </Button>
                  <Button
                    onClick={handleSave}
